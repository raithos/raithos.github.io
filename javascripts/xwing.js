    ...
    if (data !== this.tooltip_currently_displaying || force_update) {
      switch (type) {
        ...
        case 'Pilot':
          ...
          container.find('tr.info-actions td.info-data').html(this.formatActions((_ref45 = (_ref46 = data.ship_override) != null ? _ref46.actions : void 0) != null ? _ref45 : (_ref47 = effective_stats != null ? effective_stats.actions : void 0) != null ? _ref47 : ship.actions, ", ", (_ref48 = data.keyword) != null ? _ref48 : []));
          container.find('tr.info-actions').show();
          if (this.isQuickbuild) {
        ...
        case 'Quickbuild':
          ...
          if (((effective_stats != null ? effective_stats.force : void 0) != null) || (data.force != null)) {
            container.find('tr.info-force td.info-data').html(((_ref64 = (_ref65 = pilot.ship_override) != null ? _ref65.force : void 0) != null ? _ref64 : pilot.force) + '<i class="xwing-miniatures-font xwing-miniatures-font-recurring"></i>');
            container.find('tr.info-force').show();
          } else {
            container.find('tr.info-force').hide();
          }
