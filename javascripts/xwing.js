...
exportObj.CardBrowser = (function() {
  ...
  CardBrowser.prototype.checkSearchCriteria = function(card) {
    ...
    if (required_actions || required_linked_actions) {
...
Ship = (function() {
  ...
  Ship.prototype.setupUI = function() {
    var shipResultFormatter, shipicon;
