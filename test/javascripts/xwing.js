...
exportObj.SquadBuilderBackend = (function() {
  ...
  SquadBuilderBackend.prototype.setupUI = function() {
    ...
    this.login_modal.addClass('modal fade hidden-print');
    ...
    this.reload_done_modal.addClass('modal fade hidden-print');
    ...
    this.save_as_modal.addClass('modal fade hidden-print');
    ...
    this.delete_modal.addClass('modal fade hidden-print');
    ...
    this.unsaved_modal.addClass('modal fade hidden-print');
...
GenericAddon = (function() {
  ...
  GenericAddon.prototype.toHTML = function(points) {
    var attackHTML, attackrangebonus, chargeHTML, forceHTML, match_array, restriction_html, text_str, upgrade_slot_font, _base, _ref;
    if (this.data != null) {
...
exportObj.XWSManager = (function() {
  ...
  XWSManager.prototype.setupUI = function() {
    ...
    this.xws_export_modal.addClass('modal fade xws-modal hidden-print');
    ...
    this.xws_import_modal.addClass('modal fade xws-modal hidden-print');
