    ...
    if (matches != null) {
      ...
      switch (game_type_abbrev) {
        case 's':
          ...
          break;
        case 'h':
          this.changeGameTypeOnSquadLoad('blackbox');
          break;
        case 'e':
